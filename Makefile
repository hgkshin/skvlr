...
$(LIBRARY_EMPTYSKVLR): $(EMPTYSKVLR_OBJS) $(LIBRARY_HOARD) | $(LIBS_DIR)
	$(AR) $(LIBRARY_EMPTYSKVLR) $(EMPTYSKVLR_OBJS)
	$(RANLIB) $(LIBRARY_EMPTYSKVLR)
...
$(PROFILER_BIN): $(PROFILER_OBJS) $(LIBRARY_SKVLR) $(LIBRARY_UNSKVLR) $(LIBRARY_EMPTYSKVLR) | $(BIN_DIR)
	@echo + $@ [ld $^]
	@$(CC) -o $@ $^ $(LDFLAGS)
